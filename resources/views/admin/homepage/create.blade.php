...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route('homepage.update', $homePage->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @if(isset($homePage)) @method('PUT') @endif
            ...
            <div class="form-group">
                ...
                <select name="banner_type" id="banner_type" class="form-control" required>
                    ...
                    <option value="slider" {{ old('banner_type', $homePage->banner_type ?? '') == 'slider' ? 'selected' : '' }}>Slider</option>
                </select>
                @error('banner_type') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group" id="slider_images_group" style="display: none;">
                ...
                @error('slider_images') <small class="text-danger">{{ $message }}</small> @enderror
                @error('slider_images.*') <small class="text-danger">{{ $message }}</small> @enderror
            ...
            <div class="form-group">
                ...
                <textarea name="categories_text" id="categories_text"
                    class="form-control">{{ old('categories_text', $homePage->categories_text ?? '') }}</textarea>
                @error('categories_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <textarea name="aurum_text" id="aurum_text"
                    class="form-control">{{ old('aurum_text', $homePage->aurum_text ?? '') }}</textarea>
                @error('aurum_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>

            <!-- Klassic Text -->
            <div class="form-group">
                <label for="klassic_text">Klassic Text</label>
                <textarea name="klassic_text" id="klassic_text"
                    class="form-control">{{ old('klassic_text', $homePage->klassic_text ?? '') }}</textarea>
                @error('klassic_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>

            <!-- World Of Kerovit Text -->
            <div class="form-group">
                <label for="world_of_kerovit_text">World Of Kerovit Text</label>
                <textarea name="world_of_kerovit_text" id="world_of_kerovit_text"
                    class="form-control">{{ old('world_of_kerovit_text', $homePage->world_of_kerovit_text ?? '') }}</textarea>
                @error('world_of_kerovit_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" name="world_of_kerovit_image" id="world_of_kerovit_image" class="form-control"
                    value="{{ old('world_of_kerovit_image', $homePage->world_of_kerovit_image ?? '') }}">
                @error('world_of_kerovit_image') <small class="text-danger">{{ $message }}</small> @enderror
            ...
            <div class="form-group">
                ...
                @error('world_of_kerovit_button_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('world_of_kerovit_button_url') <small class="text-danger">{{ $message }}</small> @enderror
            </div>

            <div class="form-group">
    <label for="catalogue_pdf_1">Catalogue PDF 1</label>
    <input type="file" name="catalogue_pdf_1" id="catalogue_pdf_1" class="form-control">
    @error('catalogue_pdf_1') <small class="text-danger">{{ $message }}</small> @enderror

    @if(isset($homePage) && $homePage->catalogue_pdf_1)
        <div class="mt-2">
            <a href="{{ asset('storage/' . $homePage->catalogue_pdf_1) }}" target="_blank" class="btn btn-sm btn-primary">
                View Existing PDF 1
            </a>
            <br><br>
            <embed src="{{ asset('storage/' . $homePage->catalogue_pdf_1) }}" type="application/pdf" width="200px" height="200px" />
        </div>
    @endif
</div>
...
<div class="form-group">
    ...
    <input type="file" name="catalogue_pdf_2" id="catalogue_pdf_2" class="form-control">
    @error('catalogue_pdf_2') <small class="text-danger">{{ $message }}</small> @enderror

    @if(isset($homePage) && $homePage->catalogue_pdf_2)
        <div class="mt-2">
            <a href="{{ asset('storage/' . $homePage->catalogue_pdf_2) }}" target="_blank" class="btn btn-sm btn-primary">
                View Existing PDF 2
            </a>
            <br><br>
            <embed src="{{ asset('storage/' . $homePage->catalogue_pdf_2) }}" type="application/pdf" width="200px" height="200px" />
        </div>
    @endif
</div>
            ...
            <div class="form-group">
                ...
                <textarea name="about_us_text" id="about_us_text"
                    class="form-control">{{ old('about_us_text', $homePage->about_us_text ?? '') }}</textarea>
                @error('about_us_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('about_us_image') <small class="text-danger">{{ $message }}</small> @enderror
            ...
            <div class="form-group">
                ...
                @error('about_us_button_text') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('about_us_button_url') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
...
<script>
    CKEDITOR.replace('categories_text');
    CKEDITOR.replace('world_of_kerovit_text');
    CKEDITOR.replace('aurum_text');
    CKEDITOR.replace('klassic_text');
            ...
            if (files && files.length > 0) {
                for (let i = 0; i < files.length; i++) {
                    ...
                    reader.onload = function (e) {
                        const img = $('<img>').attr('src', e.target.result).addClass('img-thumbnail').css('max-width', '100%').css('height', 'auto').css('margin-right', '10px');

                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        @if($category->thumbnail_image)
                            <img src="{{ asset('storage/' . $category->thumbnail_image) }}" width="100" class="mt-2">
                        @endif
                    </div>
                    ...
                    <div class="form-group">
                        <input type="hidden" name="is_active" value="0">
                        <div class="custom-control custom-switch">
                            <input type="checkbox" class="custom-control-input" id="is_active_edit" name="is_active" value="1" {{ old('is_active', $category->is_active) ? 'checked' : '' }}>
            ...
            <table class="table table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($category->thumbnail_image)
                                <img src="{{ asset('storage/' . $category->thumbnail_image) }}" width="50">
                            @endif
                        </td>
